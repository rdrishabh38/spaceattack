...
red_dark = pygame.image.load( "SpaceRes/Images/red dark.png" ).convert_alpha()
red_light = pygame.image.load( "SpaceRes/Images/red light.png" ).convert_alpha()
...
##Till now this much is enough...will attempt more later :P
def player_hit():
    screen.blit(red_dark, (0,0))
##    Intro_clock.tick(5)
####    global t0
##    flag = True
##    while flag : 
...
####        dt = t1-t0
##        while t1 < 0.1 :
##            print "Time elapsed is", t1, "seconds less than 0.5" 
##            screen.blit(red_dark, (0,0))
##            pygame.display.update()
##        while t1 > 0.1 :
##            print "Time elapsed is", t1, "seconds more than 0.5"             
##            screen.blit(red_light, (0,0))
##            pygame.display.update()
##            if t1 > 0.2:
...
def gameloop(difficulty):
    # initialize the t0 variable, "starting the stopwatch"
    t0 = time.time()
    playerpos=[320,(height-70)] #variable to track position of player
...
##                arrow1 = pygame.transform.rotate(arrow, 360-projectile[0]*57.29)
        ...
        if badtimer==0:
            badguys.append([random.randint(22,(width-35)),0])
...
##        elif keys[1]:
##            playerpos[0]+=4
        if playerpos[0]>(width-50): #check for right boundary
            playerpos[0]=(width-50)
