...
##                position=pygame.mouse.get_pos()
                acc[1]+=1
                angle = math.atan2((position[1]-100)-playerpos1[1],0)
                if angle > 0:
                    angle *= -1
                arrows.append([angle,playerpos1[0]+60,playerpos1[1]+40])
##                print ([math.atan2((position[1]-100)-playerpos1[1],0),playerpos1[0]+60,playerpos1[1]+40])
                bb = 0
        clock.tick(FPS)
